...
// guess_initial
arma::vec guess_initial(const std::vector<std::string>& desc, const arma::field<arma::vec>& objdesc, std::string model_type, unsigned int num_param, double expect_diff, unsigned int N, const arma::vec& wv_empir, const arma::vec& tau, double ranged, unsigned int G);
RcppExport SEXP gmwm_guess_initial(SEXP descSEXP, SEXP objdescSEXP, SEXP model_typeSEXP, SEXP num_paramSEXP, SEXP expect_diffSEXP, SEXP NSEXP, SEXP wv_empirSEXP, SEXP tauSEXP, SEXP rangedSEXP, SEXP GSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const std::vector<std::string>& >::type desc(descSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type ranged(rangedSEXP);
    Rcpp::traits::input_parameter< unsigned int >::type G(GSEXP);
    __result = Rcpp::wrap(guess_initial(desc, objdesc, model_type, num_param, expect_diff, N, wv_empir, tau, ranged, G));
    return __result;
END_RCPP
}
// ar1_draw
