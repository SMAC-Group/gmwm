...
#'
#' Creates a \code{gmwm_robust} object to compare the results generated by robust/classical method.
#' @param model A \code{ts.model} object containing one of the allowed models.
...
#' @param ... Several \code{gmwm} objects, and they must be constrcuted by the same data and same model. Or one \code{gmwm_robust} object created by \code{\link{gmwm_robust}} function.
