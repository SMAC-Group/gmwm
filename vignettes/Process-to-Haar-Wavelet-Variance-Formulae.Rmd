...
$$\frac{\partial }{{\partial \phi }}\frac{\partial }{{\partial {\sigma ^2}}}\nu _j^2\left( {\phi ,{\sigma ^2}} \right) = \frac{{2{\sigma ^2}}}{{{{(\phi  - 1)}^7}{{(\phi  + 1)}^3}\tau _j^4}}\left( {\left( {{\phi ^2} - 1} \right){\tau _j} + 2\phi \left( {{\phi ^{{\tau _j}}} - 4{\phi ^{\frac{{{\tau _j}}}{2}}} + 3} \right)} \right)\left( {\left( {{\phi ^2} - 1} \right){\tau _j}\left( {{\phi ^{{\tau _j}}} - 2{\phi ^{\frac{{{\tau _j}}}{2}}} - \phi  - 1} \right) - ((3\phi  + 2)\phi  + 1)\left( {{\phi ^{{\tau _j}}} - 4{\phi ^{\frac{{{\tau _j}}}{2}}} + 3} \right)} \right)
$$
...
$$
\frac{\partial }{{\partial \theta }}\frac{\partial }{{\partial {\sigma ^2}}}\nu _j^2\left( {\theta ,{\sigma ^2}} \right) = \frac{{{\sigma ^2}\left( {2\left( {\theta  + 1} \right){\tau _j} - 6} \right)\left( {{{\left( {\theta  + 1} \right)}^2}{\tau _j} - 6\theta } \right)}}{{\tau _j^4}}
$$
...
**Derivative w.r.t. $\phi$, $\theta$, and $\sigma^2$:**


\[\frac{\partial }{{\partial \phi }}\frac{\partial }{{\partial \theta }}\frac{\partial }{{\partial {\sigma ^2}}}\nu _j^2\left( {\phi ,\theta ,{\sigma ^2}} \right) =  - \frac{{8{\sigma ^4}}}{{{{(\phi  - 1)}^{10}}{{(\phi  + 1)}^4}\tau _j^6}}\left[ \begin{aligned}
...
\end{aligned}  \right) \\
  ...
  &{\theta ^2}(\phi (3\phi  + 2) + 1) \\
   ...
   &+ \phi (3\phi  + 2) + 1 \\ 
\end{aligned}  \right)\left( {{\phi ^{{\tau _j}}} - 4{\phi ^{\frac{{{\tau _j}}}{2}}} + 3} \right) \\ 
\end{aligned}  \right) \\ 
\end{aligned}  \right]\]